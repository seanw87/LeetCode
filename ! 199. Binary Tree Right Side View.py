...
"""
Solution 1: typical BFS
Solution 2: typical DFS
Solution 3: customized DFS (projection to the right side and supplement the left side(if right side not existed)
"""
...
print(Solution2().rightSideView(tree))
